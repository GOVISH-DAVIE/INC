...
class CreateGender extends StatefulWidget {
  ...
  const CreateGender({super.key, required this.cxn});

  @override
  State<CreateGender> createState() => _CreateCountiesState();
}

class _CreateCountiesState extends State<CreateGender> {
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              onPressed: () {
                ...
                context
                    .read<GenderNotifier>()
                    .createGender(payload: _formKey.currentState!.value)
                    .then((value) {
