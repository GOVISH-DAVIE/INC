...
class MediumList extends StatefulWidget {
  ...
  const MediumList({super.key, required this.list, required this.prority});

  @override
  State<MediumList> createState() => _HighListState();
}

class _HighListState extends State<MediumList> {
  @override
