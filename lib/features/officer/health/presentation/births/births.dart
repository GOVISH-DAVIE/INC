...
import 'birth_list.dart';

class Births extends StatefulWidget {
  const Births({super.key});

  @override
  State<Births> createState() => _PregnantMomsState();
}

class _PregnantMomsState extends State<Births> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
              onPressed: () {
                context.appNavigatorPush(const BirthList());
              },
                      ...
                      onPressed: () {
                        ...
                        context
                          ...
                          context.showCustomSnackBar(
                              "Birth Reported successfully");

                          // Navigator.of(widget.cxn).pop();
                        }).catchError((onError) {
                          logger.wtf(onError);
                          context.showCustomSnackBar("[Birth] An Error Occured",
                              isError: true);
                        });
                      },
