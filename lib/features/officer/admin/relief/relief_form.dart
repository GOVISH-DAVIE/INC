...
import 'relief_form_recipients.dart';

class ReliefForm extends StatefulWidget {
  final String reliefType;
  const ReliefForm({super.key, required this.reliefType});

  @override
  State<ReliefForm> createState() => _ReliefState();
}

class _ReliefState extends State<ReliefForm> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            "${widget.reliefType} Distribution ",
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  ...
                                  payload["type_of_relief"] =
                                      (widget.reliefType);
                                  context.appNavigatorPush(ReliefFormRecipients(
