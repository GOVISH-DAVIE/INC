...
mixin _$Ward {
  ...
  List<Village>? get village => throw _privateConstructorUsedError;
...
class _$WardImpl implements _Ward {
  _$WardImpl(
      ...
      @JsonKey(name: 'Village') final List<Village>? village})
      : _village = village;
  ...
  final List<Village>? _village;
  @override
  @JsonKey(name: 'Village')
  List<Village>? get village {
    final value = _village;
    if (value == null) return null;
    if (_village is EqualUnmodifiableListView) return _village;
  ...
  @override
  String toString() {
    return 'Ward(id: $id, name: $name, code: $code, subCountyId: $subCountyId, createdAt: $createdAt, village: $village)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other._village, _village));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, code, subCountyId,
      createdAt, const DeepCollectionEquality().hash(_village));
...
abstract class _Ward implements Ward {
  factory _Ward(
      ...
      @JsonKey(name: 'Village') final List<Village>? village}) = _$WardImpl;
