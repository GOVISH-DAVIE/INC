...
mixin _$Village {
  ...
  List<ReliefDistribution>? get reliefDistribution =>
...
class _$VillageCopyWithImpl<$Res, $Val extends Village>
  ...
  $Res call({
    ...
    Object? reliefDistribution = freezed,
  }) {
    return _then(_value.copyWith(
      ...
      createdAt: freezed == createdAt
          ...
          : createdAt // ignore: cast_nullable_to_non_nullable
              as DateTime?,
      reliefDistribution: freezed == reliefDistribution
          ? _value.reliefDistribution
          : reliefDistribution // ignore: cast_nullable_to_non_nullable
              as List<ReliefDistribution>?,
    ) as $Val);
  }
}
...
class _$VillageImpl implements _Village {
  _$VillageImpl(
      ...
      @JsonKey(name: 'Relief_distribution')
      final List<ReliefDistribution>? reliefDistribution})
      : _reliefDistribution = reliefDistribution;
  ...
  final List<ReliefDistribution>? _reliefDistribution;
  @override
  @JsonKey(name: 'Relief_distribution')
  List<ReliefDistribution>? get reliefDistribution {
    final value = _reliefDistribution;
    if (value == null) return null;
    if (_reliefDistribution is EqualUnmodifiableListView)
      return _reliefDistribution;
  ...
  @override
  String toString() {
    return 'Village(id: $id, name: $name, description: $description, wardId: $wardId, createdAt: $createdAt, reliefDistribution: $reliefDistribution)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._reliefDistribution, _reliefDistribution));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, description, wardId,
      createdAt, const DeepCollectionEquality().hash(_reliefDistribution));
...
abstract class _Village implements Village {
  factory _Village(
      ...
      @JsonKey(name: 'Relief_distribution')
      final List<ReliefDistribution>? reliefDistribution}) = _$VillageImpl;
