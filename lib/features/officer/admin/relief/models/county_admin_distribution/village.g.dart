...
_$VillageImpl _$$VillageImplFromJson(Map<String, dynamic> json) =>
    _$VillageImpl(
      ...
      reliefDistribution: (json['Relief_distribution'] as List<dynamic>?)
          ?.map((e) => ReliefDistribution.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
...
Map<String, dynamic> _$$VillageImplToJson(_$VillageImpl instance) =>
    <String, dynamic>{
      ...
      'Relief_distribution': instance.reliefDistribution,
    };
