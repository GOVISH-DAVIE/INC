...
void setupLocator() {
  locator.registerFactory<HealthAdminNotifier>(() => HealthAdminNotifier());
  ...
  locator.registerFactory<ReceiveReliefNotifier>(() => ReceiveReliefNotifier());
  locator.registerFactory<DistributeReliefNotifier>(
      () => DistributeReliefNotifier());
}
